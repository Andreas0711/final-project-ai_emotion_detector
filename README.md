...
Multi-Emotion Scoring: The system extracts and displays scores for five distinct categories:
...
Libraries: requests (API communication), json (data parsing), unittest (testing)
